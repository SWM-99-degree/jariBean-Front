...
final socialLoginProvider = StateNotifierProvider<SocialLoginStateNotifier,
    SocialLoginResponseModelBase>((ref) {
...
class SocialLoginStateNotifier
    extends StateNotifier<SocialLoginResponseModelBase> {
